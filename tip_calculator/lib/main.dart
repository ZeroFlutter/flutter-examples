...
class TipCalculator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextField billAmountField = new TextField(
      ...
      decoration: new InputDecoration(labelText: "Bill amount(\$)",helperText: 'asdas',filled:true,border: new OutlineInputBorder()),
    );
    ...
    RaisedButton calculateButton = new RaisedButton(
        ...
        onPressed: () {
          ...
          AlertDialog dialog = new AlertDialog(
            ...
            actions: <Widget>[new Text('cancel'),new Text('OK')],
            title: new Text('你好,Alert'),
              semanticLabel: 'haha',
